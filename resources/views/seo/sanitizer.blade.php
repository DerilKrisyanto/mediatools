...
@php
    ...
    $faq = [
        [
            'q' => 'Apa itu File Security & Privacy Scanner?',
            'a' => 'Tool online untuk mendeteksi potensi ancaman tersembunyi dalam file seperti backdoor, script berbahaya, serta menghapus metadata sensitif seperti lokasi GPS dan informasi perangkat.',
        ],
        [
            'q' => 'Apa itu PHP Backdoor & Shell Exec dan mengapa berbahaya?',
            'a' => 'Backdoor memungkinkan akses tersembunyi ke server, sedangkan shell exec memungkinkan eksekusi perintah sistem. Keduanya sering digunakan oleh hacker untuk mengambil alih sistem tanpa izin.',
        ],
        [
            'q' => 'Apa itu JPEG Polyglot & PDF JavaScript?',
            'a' => 'File yang terlihat normal seperti gambar atau PDF, tetapi menyisipkan kode berbahaya di dalamnya untuk menghindari deteksi sistem keamanan.',
        ],
        [
            'q' => 'Apa itu Encoded Payload?',
            'a' => 'Teknik menyamarkan kode berbahaya dalam bentuk encoding seperti Base64 agar sulit dideteksi oleh antivirus atau scanner biasa.',
        ],
        [
            'q' => 'Mengapa metadata berbahaya?',
            'a' => 'Metadata dapat menyimpan informasi sensitif seperti lokasi GPS, jenis perangkat, waktu pengambilan, bahkan identitas pengguna. Data ini bisa disalahgunakan untuk pelacakan atau profiling.',
        ],
        [
            'q' => 'Apakah kualitas file berubah setelah metadata dihapus?',
            'a' => 'Tidak. Proses hanya menghapus data tersembunyi tanpa mengubah isi utama file, sehingga kualitas tetap terjaga.',
        ],
        [
            'q' => 'Apakah file saya aman?',
            'a' => 'Ya. Semua file diproses di server MediaTools tanpa dibagikan ke pihak ketiga dan akan dihapus otomatis setelah proses selesai.',
        ],
        [
            'q' => 'Format file apa saja yang didukung?',
            'a' => 'Saat ini mendukung JPG, JPEG, PNG, WebP untuk gambar dan PDF untuk dokumen.',
        ],
        [
            'q' => 'Bisakah scan banyak file sekaligus?',
            'a' => 'Ya, Anda dapat mengupload hingga 10 file sekaligus dengan maksimal ukuran 20MB per file.',
        ],
    ];
    ...
    $howToSchema = [
        ...
        'step' => [
            [
                ...
                'position' => 1,
                'name' => 'Upload file',
                'text' => 'Pilih file gambar atau PDF yang ingin diperiksa.',
            ],
            [
                '@type' => 'HowToStep',
                'position' => 2,
                'name' => 'Proses scanning',
                'text' => 'Sistem akan mendeteksi potensi ancaman dan metadata tersembunyi.',
            ],
            [
                '@type' => 'HowToStep',
                'position' => 3,
                'name' => 'Review hasil',
                'text' => 'Lihat hasil deteksi apakah ada backdoor, script, atau metadata sensitif.',
            ],
            [
                '@type' => 'HowToStep',
                'position' => 4,
                'name' => 'Download file bersih',
                'text' => 'Unduh file yang sudah dibersihkan dan aman digunakan.',
            ],
        ],
    ];
    ...
    $schema = [
        ...
        [
            ...
            'primaryImageOfPage' => [
                '@type' => 'ImageObject',
                'url'   => $appUrl . '/images/og/sanitizer.png',
            ],
        ],
    ];
@endphp
