...
@section('title', 'Background Remover — Hapus Background Foto | MediaTools')
@section('meta_description', 'Hapus background foto otomatis dengan AI BiRefNet. Edit manual dengan brush. Proses server-side, privasi terjaga.')
