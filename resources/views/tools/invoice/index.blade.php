@extends('layouts.app')
@section('title', 'Invoice Generator - Buat Tagihan Profesional Gratis | MediaTools')
@section('meta_description', 'Buat invoice profesional secara gratis dalam hitungan detik. Template siap pakai, ekspor PDF, format Rupiah. Tanpa daftar, langsung pakai.')
