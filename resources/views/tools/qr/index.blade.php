@extends('layouts.app')
@section('title', 'QR Code Generator - Buat QR Code Custom Gratis | MediaTools')
@section('meta_description', 'Buat QR Code custom untuk link, menu restoran, pembayaran, dan kontak bisnis. Desain branded, ekspor PNG/SVG, 100% gratis.')
@section('content')
